...
public class EmployeeRoster {
    ...
    public void displayAllEmployees(){
        ...
        for(Employee emp: empList ){
            System.out.println(String.format(allFormat,
                  ""+  emp.getEmpID(),emp.getEmpName(),""+emp.getClass().getSimpleName(),emp.computeSalary()));
        }
    }
    ...
    public void displayEmpType(String key){
        EmployeeRoster type = new EmployeeRoster();
        for(Employee emp : empList){
            if(this.checkInstance(emp, key)){
                type.addEmployee(emp);
            }
        }
        type.displayAllEmployees();
    }
