...
public class PieceWorkerEmployee extends Employee{
    ...
    public PieceWorkerEmployee(int ID,Name name,Date hired,Date birth,int totalPieces,float rate){
        super(ID,name,hired,birth);
        totalPiecesFinished = totalPieces;
        ratePerPiece = rate;
    }
    public PieceWorkerEmployee(int ID,String first, String middle , String last,Date hired,Date birth,int totalPieces,float rate){
